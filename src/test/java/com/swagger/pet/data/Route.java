package com.swagger.pet.data;

public class Route {
    public static final String ADDING_API ="/v2/pet";
    public static final String FINDING_BY_STATUS_API ="/v2/pet/findByStatus";
    public static final String FINDING_BY_ID_API ="/v2/pet/{id}";
    public static final String GET_PET_INVENTORIES ="/v2/store/inventory";
